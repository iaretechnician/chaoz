...
namespace uSurvival
{
    ...
    #pragma warning restore CS0109 // member does not hide accessible member
        ...
        public Vector3 lookDirectionFar =>
            isLocalPlayer ? camera.transform.forward : syncedLookDirectionFar;
        ...
        public Vector3 lookDirectionRaycasted =>
            (lookPositionRaycasted - headPosition).normalized;
        ...
        void OnDrawGizmos()
        {
            // only while playing. isLocalPlayer can't be accessed in Editor.
