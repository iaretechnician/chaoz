...
namespace uSurvival
{
    ...
    #pragma warning restore CS0109 // member does not hide accessible member
        ...
        bool EventDied() => health.current == 0;
        ...
        bool EventJumpRequested() =>
            isGroundedWithinTolerance &&
            controller.slidingState == SlidingState.NONE &&
            jumpKeyPressed;

        bool EventCrouchToggle() => crouchKeyPressed;

        bool EventCrawlToggle() => crawlKeyPressed;
        ...
        bool EventFalling() => !isGroundedWithinTolerance;

        bool EventLanded() => controller.isGrounded;
        ...
        bool EventLadderEnter() => ladderCollider != null;
