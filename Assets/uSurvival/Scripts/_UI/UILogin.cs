...
namespace uSurvival
{
    public class UILogin : MonoBehaviour
    {
        ...
        void Start()
        {
	        ...
	        accountInput.text=PlayerPrefs.GetString("LoginName","Newbie");
	        passwordInput.text=PlayerPrefs.GetString("LoginPass","password");
        ...
        void Update()
        {
            ...
            if (manager.state == NetworkState.Offline || manager.state == NetworkState.Handshake)
            {
	            ...
	            PlayerPrefs.SetString("LoginName",accountInput.text);
	            PlayerPrefs.SetString("LoginPass",passwordInput.text);
