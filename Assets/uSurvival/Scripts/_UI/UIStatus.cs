    ...
    public class UIStatus : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (player)
            {
                ...
                string toStringFormat = $"F{temperatureDecimalDigits}"; // "F2" etc.
                temperatureStatus.text = $"{currentTemperature.ToString(toStringFormat)} / {maxTemperature.ToString(toStringFormat)} {temperatureUnit}";
